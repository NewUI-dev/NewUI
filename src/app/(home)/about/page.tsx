...
import { Github, Twitter, Linkedin, Heart, Users, Code, Zap } from "lucide-react"
...
const values = [
  ...
  },
  {
    ...
    description: "Our community shapes the future of NewUI. We listen, learn, and build together.",
  },
  {
    icon: Code,
    title: "Open Source",
    description: "Transparency and collaboration are at our core. Everything we build is open source.",
  },
  {
    icon: Zap,
    title: "Performance First",
    description: "We obsess over performance. Every component is optimized for speed and efficiency.",
  },
]
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="text-center mb-16 sm:mb-20">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-foreground mb-4 sm:mb-6">
            About{" "}
            <span className="bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent">NewUI</span>
          </h1>
          <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto">
            We're on a mission to make building beautiful, accessible user interfaces easier and faster for developers
            everywhere.
          </p>
        </div>
            ...
            <CardContent className="p-8 sm:p-12">
              ...
              <div className="prose prose-gray dark:prose-invert max-w-none">
                <p className="text-muted-foreground leading-relaxed mb-4">
                  NewUI was born out of frustration with the current state of component libraries. We were tired of
                  dealing with complex installations, version conflicts, and components that didn't quite fit our needs.
                </p>
                <p className="text-muted-foreground leading-relaxed mb-4">
        ...
        <div className="mb-16 sm:mb-20">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground mb-4">Our Values</h2>
        ...
        <div className="mb-16 sm:mb-20">
          <div className="text-center mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-foreground mb-4">Meet the Team</h2>
            <p className="text-lg text-muted-foreground">The people behind NewUI</p>
          </div>
          ...
          <Card className="border-0 bg-gradient-to-br from-primary/5 to-primary/10">
            <CardContent className="p-8 sm:p-12">
              ...
              <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
                Be part of the growing community of developers building amazing applications with NewUI.
              </p>
