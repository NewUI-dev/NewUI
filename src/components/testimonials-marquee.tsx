...
const testimonials = [
	...
	{
		content:
			"The copy-paste approach is genius. No more dealing with package installations and version conflicts.",
		author: "David Kim",
	...
	{
		content:
			"Best component library I've used. The blocks feature is a game-changer for rapid prototyping.",
		author: "Lisa Wang",
	...
	{
		content:
			"The accessibility features are top-notch. Finally, a component library that takes a11y seriously.",
			...
			<div className="container mx-auto px-4 sm:px-6 lg:px-8 mb-12 sm:mb-16">
				<div className="mx-auto max-w-2xl text-center">
					...
					<p className="text-lg sm:text-xl text-muted-foreground">
						See what developers are saying about NewUI
					</p>
				</div>
			</div>
