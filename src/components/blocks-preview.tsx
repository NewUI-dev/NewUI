  ...
  },
  {
    ...
    preview: (
      <div className="text-center space-y-3">
        ...
        <p className="text-sm text-muted-foreground">Join thousands of users</p>
    ...
    <section className="py-20 sm:py-32 bg-muted/20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-foreground sm:text-4xl">Pre-built Blocks</h2>
          <p className="mt-4 text-lg text-muted-foreground">Copy-paste ready sections for common UI patterns</p>
        </div>
